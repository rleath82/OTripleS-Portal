...
namespace OTripleS.Portal.Web.Tests.Unit.Services.Students
{
    public partial class StudentServiceTests
    {
        ...
        public async Task ShouldThrowValidationExceptionOnRegisterIfCreatedDateIsInvalidAndLogItAsync()
        {
            ...
            var invalidStudentException = new InvalidStudentException(parameterName: nameof(Student.CreatedDate), parameterValue: invalidStudent.CreatedDate);
        ...
        public async Task ShouldThrowValidationExceptionOnRegisterIfUpdatedDateIsInvalidAndLogItAsync()
        {
            ...
            var invalidStudentException = new InvalidStudentException(parameterName: nameof(Student.UpdatedDate), parameterValue: invalidStudent.UpdatedDate);
